...
# make predictions
with open('../output_files/results/suffix_and_remaining_time11_%s' % eventlog, 'wb') as csvfile:
            ...
            for i in range(predict_size):
                for k in range(current_beam_size):
                    ...
                    if not found_sattisfying_constraint:
                        if verify_formula_as_compliant(current_prediction_premis.cropped_line, prefix_size):
                    ...
                    for j in range(current_beam_size):
                        ...
                        if temp_prediction == '!':  # end of case was just predicted, therefore, stop predicting further into the future
                            if verify_formula_as_compliant(temp_cropped_line, prefix_size):
